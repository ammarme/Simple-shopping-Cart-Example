package com.example.simpleshoppingcartexample.Adapter;
...
import com.example.simpleshoppingcartexample.Model.ProductImage;
import com.example.simpleshoppingcartexample.R;

import java.util.ArrayList;

import static com.example.simpleshoppingcartexample.CartActivity.grandTotalplus;
import static com.example.simpleshoppingcartexample.CartActivity.grandTotal;

import static com.example.simpleshoppingcartexample.CartActivity.temparraylist;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_activity_cart, parent, false);
